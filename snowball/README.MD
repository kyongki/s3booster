...
Here is help 
```sh
s3booster]$ python3 s3booster-upload-snowball-20210810-test.py -h
usage: s3booster-upload-snowball-20210810-test.py [-h] --bucket_name
                                                  BUCKET_NAME --src_dir
                                                  SRC_DIR [--region REGION]
                                                  --endpoint ENDPOINT
...
optional arguments:
  ...
  --region REGION       aws_region e) ap-northeast-2
